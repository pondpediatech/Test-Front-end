...
const Messages: React.FC = () => {
  ...
  useEffect(() => {
    if (messageRecords) {
      const chatList = messageRecords.conversation.map((record, index) => ({
        // value: { selectedThreadId: index }, // replace this with actual thread ID if available
        // name: record.role === "user" ? "User Name" : "Other Name", // replace "User Name" and "Other Name" with actual names
              ...
              <div className="ml-auto max-w-125">
                <div className="mb-5 rounded-2xl rounded-br-none bg-primary px-5 py-3">
                  <p className="text-white">
                    Hello, Thomas! I appreciate your patience. I understand that
                    you need some time to review the schedule. Please take all
                    the time you need. Once you have checked the schedule,
