...
import { createThreadFetcher, createMessageFetcher, fetchThreads } from "./fetcher";
...
export default function MessagesPage() {
        ...
        <div className="chat-footer">
          ...
          <form onSubmit={handleMessageSubmit} className="message-form">
            ...
            <button
              ...
              disabled={isSending || !selectedThreadId || newMessage.trim().length === 0}
            >
          ...
          <select
            ...
            disabled={!selectedAssistantId || isSending}
  ...
  // useEffect(() => {
  //   if (isCreatingThread) {
  //     // Do something when isCreatingThread is true
  //   } else {
  //     // Do something when isCreatingThread is false
  //     setThreads(threadsData.threads.docs);
  //   }
  //  }, [isCreatingThread]);